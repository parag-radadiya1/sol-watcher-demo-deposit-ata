export const resendEmailVerifyTemplate = (verificationUrl: string) => `
<body style="font-family: Arial, sans-serif; line-height: 1.6; margin: 0; padding: 0; background-color: #f4f4f9; color: #333;">
    <div style="max-width: 600px; margin: 20px auto; background: #fff; padding: 20px; border-radius: 10px; box-shadow: 0 0 7px rgba(0, 0, 0, 0.15);">
        ...
        <div style="margin: 20px 0;">
            ...
            <p>You requested to resend your email verification for your Fynetone account. Please click the button below to verify your email address, or copy and paste the link into your browser:</p>
            <p><strong>Verification Link:</strong> ${verificationUrl}</p>

            <a href="${verificationUrl}" style="display: inline-block; margin-top: 20px; padding: 10px 20px; background: #007bff; color: #fff; text-decoration: none; border-radius: 5px;">Verify your email</a>
